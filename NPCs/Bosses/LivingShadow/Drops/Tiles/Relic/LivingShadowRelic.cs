...
namespace Conquest.NPCs.Bosses.LivingShadow.Drops.Tiles.Relic;
...
public class LivingShadowRelic : ModTile
{
    ...
    public virtual string RelicTextureName => "Conquest/Assets/Textures/Tiles/LivingShadowRelic";

    // All relics use the same pedestal texture, this one is copied from vanilla
    public override string Texture => "Conquest/Assets/Textures/Tiles/RelicPedestal";
    ...
    public override void KillMultiTile(int i, int j, int frameX, int frameY)
    {
        ...
        {
            case 0:
                itemType = ModContent.ItemType<LivingShadowRelicItem>();
                break;
