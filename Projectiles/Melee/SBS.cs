...
namespace Conquest.Projectiles.Melee
{
    ...
    //This is part of the stygian blades slash - we should probably make abstact classes for these at some point so i dont have to copy stuff
    public class SBS : ModProjectile
    {

        public float startRotation; //match up with the start of the
        public bool reverseRot; //-1: counter clockwise, 1: clockwise // for reverse swing
        ...
        {
            writer.Write(reverseRot);
            writer.Write(startRotation);
        }
        public override void ReceiveExtraAI(BinaryReader reader)
        {
            reverseRot = reader.ReadBoolean();
        ...
        public override void AI()
        {
            ...
            float velocityRotation = startRotation + (direction == 1 ? MathHelper.Pi : 0) + Projectile.velocity.ToRotation();
            float adjustedRotation = (reverseRot ? -1 : 1) * MathHelper.Pi * direction * percentageOfLife + velocityRotation + direction * MathHelper.Pi + player.fullRotation + (reverseRot ? direction * MathHelper.PiOver2 * 1.2f : 0);
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.DarkRed, Color.White, Main.rand.NextFloat() * 0.3f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (reverseRot) { texture = ModContent.Request<Texture2D>("Conquest/Projectiles/Melee/dontdelete").Value; }
            ...
            Color backDarkColor = new Color(180, 60, 60); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(255, 80, 80); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(255, 150, 150); // Original Excalibur color: Color(255, 240, 150)
